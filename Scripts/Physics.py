            ...
            for entity in chunk.entities:
                ...
                if entity.vel.x != 0:
                    ...
                    for bx,by,bz in self.getCollidingBlocks(e_collider):
                        ...
                        # print(bx%Chunk.SIZE,by%Chunk.SIZE,bz%Chunk.SIZE)
                ...
                entity.vel.y -= 28.4491046268 * dt
                entity.vel.xz = entity.vel.xz - entity.vel.xz* 0.4
                

                # entity.vel = entity.vel*(1- 0.2)
        # assert entities == 1
        # print(self.getCollidingBlocks(self.player.collider))
